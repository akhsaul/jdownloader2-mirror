...
public class KernelVideoSharingPorntnCom extends KernelVideoSharingComV2 {
    public KernelVideoSharingPorntnCom(final PluginWrapper wrapper) {
        super(wrapper);
    ...
    protected String getPrivateVideoWebsiteMessage(final Browser br) {
        if (br.containsHTML("for free to access video|>\\s*PornTN will be FULLY Private Soon")) {
            return "Log in or sign up for free to access videos.";
        } else {
