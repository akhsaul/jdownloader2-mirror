...
public class CrazypornXxx extends KernelVideoSharingComV2 {
    public CrazypornXxx(final PluginWrapper wrapper) {
        super(wrapper);
    }
    ...
    public static final boolean isOfflineStatic(final Browser br) {
        ...
        if (br.getHttpConnection().getResponseCode() == 404) {
            ...
            return true;
        } else if (!br.containsHTML("/embed/\\d+")) {
            /**
             * Website does not contain own videoID in embed url -> Item must be offline </br>
             * Example: https://crazyporn.xxx/videos/677777/summer-fun
             */
            return true;
        } else {
            return false;
