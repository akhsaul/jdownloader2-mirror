...
@HostPlugin(revision = "$Revision: 52238 $", interfaceVersion = 3, names = {}, urls = {})
public class LarhuCom extends XFileSharingProBasic {
    ...
    public static List<String[]> getPluginDomains() {
        ...
        ret.add(new String[] { "larhu.website", "larhu.com" });
        return ret;
    }
    ...
    protected List<String> getDeadDomains() {
        ...
        deadDomains.add("larhu.com");
        return deadDomains;
    }

    @Override
    public String rewriteHost(final String host) {
        /* 2026-02-02: Main domain changed from larhu.com to larhu.website */
