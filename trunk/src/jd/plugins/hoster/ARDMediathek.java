...
public class ARDMediathek extends PluginForHost {
    ...
    public String getLinkID(final DownloadLink link) {
        ...
        final String itemAudioLanguage = data.getAudioLanguage();
        if (itemId != null && itemSrc != null && itemType != null && itemRes != null) {
            ...
            if (data.getSpeechOptimized()) {
                ret += "_SO";
            }
            if (itemAudioLanguage != null) {
                ret += "_audiolng=" + itemAudioLanguage + "_";
            }
            return ret;
        }
    ...
    public static String getMD5FromEtag(final URLConnectionAdapter con) {
        if (con == null) {
            return null;
        }
        final String etag = con.getRequest().getResponseHeader(HTTPConstants.HEADER_ETAG);
        if (etag == null) {
            return null;
        }
        try {
