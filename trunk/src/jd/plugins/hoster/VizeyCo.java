...
public class VizeyCo extends PluginForHost {
    ...
    public static String[] getAnnotationUrls() {
        ...
        for (final String[] domains : getPluginDomains()) {
            ret.add("https?://(?:www\\.)?" + buildHostsPatternPart(domains) + "/e/([A-Za-z0-9]{10,})");
        }
    ...
    public AvailableStatus requestFileInformation(final DownloadLink link) throws IOException, PluginException {
        ...
        br.getPage("https://vizey.co/api/videos/public?id=" + fid + "&noCount=true");
        ...
        link.setFinalFileName(video.get("filename").toString());
        link.setVerifiedFileSize(((Number) video.get("size")).longValue());
        dllink = (String) video.get("url");
