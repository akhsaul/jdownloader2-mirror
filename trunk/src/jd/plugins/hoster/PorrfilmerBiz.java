...
public class PorrfilmerBiz extends PluginForHost {
    public PorrfilmerBiz(PluginWrapper wrapper) {
        super(wrapper);
    }
    ...
    public static List<String[]> getPluginDomains() {
        ...
        ret.add(new String[] { "porrfilmer.biz" });
        return ret;
    }
    ...
    public AvailableStatus requestFileInformation(final DownloadLink link) throws Exception {
        ...
        /* Get title from URL */
        final String filename = title + extDefault;
        ...
        if (!StringUtils.isEmpty(dllink)) {
            ...
            /**
             * No downloadlink found -> Maybe video is offline without error message in html (player missing) example: <br>
             * https://porrfilmer.biz/video/1352/blond-tik-sonja-bengtsson-porr-blir-svart-kuk-i-rven-doggy-style/
             */
            if (!br.containsHTML("/video/" + fid)) {
                throw new PluginException(LinkStatus.ERROR_FILE_NOT_FOUND);
            }
        }
