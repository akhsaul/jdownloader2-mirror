...
public class FrancetelevisionsFr extends PluginForHost {
    public FrancetelevisionsFr(PluginWrapper wrapper) {
        super(wrapper);
    }
    ...
    public AvailableStatus requestFileInformation(final DownloadLink link) throws Exception {
        ...
        /* 2025-04-02: See https://github.com/yt-dlp/yt-dlp/blob/master/yt_dlp/extractor/francetv.py#L103 */
        final String json = this.br.getPage("https://k7.ftven.fr/videos/" + videoid + "?country_code=FR&catalogue=" + catalogue + "&device_type=desktop&browser=chrome");
