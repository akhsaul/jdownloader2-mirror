...
public class GxplayerXyz extends PluginForHost {
    ...
    private static List<String[]> getPluginDomains() {
        ...
        ret.add(new String[] { "gxplayer.xyz" });
        return ret;
    }
    ...
    public static String[] getAnnotationUrls() {
        ...
        for (final String[] domains : getPluginDomains()) {
            ret.add("https?://watch\\." + buildHostsPatternPart(domains) + "/watch\\?v=([A-Za-z0-9]{8})");
        }
    ...
    public AvailableStatus requestFileInformation(final DownloadLink link) throws IOException, PluginException {
        ...
        } else if (br.containsHTML(">\\s*Video is not found")) {
            throw new PluginException(LinkStatus.ERROR_FILE_NOT_FOUND);
        }
    ...
    private void handleDownload(final DownloadLink link) throws Exception, PluginException {
        ...
        final String video_hash = br.getRegex("\"md5\":\"([a-f0-9]{32})").getMatch(0);
        final String video_uid = br.getRegex("\"uid\":\"(\\d+)").getMatch(0);
        /* Typically a single number */
        final String video_id = br.getRegex("\"id\":\"(\\d+)").getMatch(0);
        if (video_hash == null || video_uid == null || video_id == null) {
