...
public class ZapuploadTop extends PluginForHost {
    ...
    private static List<String[]> getPluginDomains() {
        ...
        /* Similar to: SwiftuploadsCom, BestfileIo */
        ret.add(new String[] { "zapupload.top" });
        return ret;
    }
    ...
    public AvailableStatus requestFileInformation(final DownloadLink link) throws IOException, PluginException {
        ...
        String filename = br.getRegex("class=\"text-break h3\">([^<]+)<").getMatch(0);
        String filesize = br.getRegex("<div class=\"col\">\\s*<span>\\((\\d+[^<]+)\\)\\s*</span>").getMatch(0);
        if (filename != null) {
