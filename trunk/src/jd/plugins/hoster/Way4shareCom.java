...
public class Way4shareCom extends YetiShareCore {
    public Way4shareCom(PluginWrapper wrapper) {
        super(wrapper);
    ...
    public void checkErrors(final Browser br, final DownloadLink link, final Account account) throws PluginException {
        ...
        if (!StringUtils.isEmpty(errorMsgURL)) {
            if (errorMsgURL.matches("You must be a paid user to download this file.*")) {
                /* 2025-08-25: Special */
