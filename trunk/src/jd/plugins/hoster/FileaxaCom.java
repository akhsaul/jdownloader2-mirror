...
public class FileaxaCom extends XFileSharingProBasic {
    ...
    public static List<String[]> getPluginDomains() {
        ...
        ret.add(new String[] { "fileaxa.com" });
        return ret;
    }
    ...
    protected boolean supports_availablecheck_alt() {
        /*
         * 2020-08-23: psp: Disabled for now because it would require a custom RegEx (Override of massLinkcheckerParseFileInfo) but I was
         * too lazy for that.
         */
        return false;
    }
