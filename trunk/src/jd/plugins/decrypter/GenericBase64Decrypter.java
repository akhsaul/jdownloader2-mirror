 ...
 *
 */
@DecrypterPlugin(revision = "$Revision$", interfaceVersion = 3, names = { "rawBase64", "noriskdomain.com", "djurl.com", "hbrowse.com", "bookgn.com", "vip-files.net", "psdkeys.com", "hovatek.com", "ctvout.buzz" }, urls = { "(^(?:[A-Za-z0-9+/]{4})*(?:[A-Za-z0-9+/]{2}==|[A-Za-z0-9+/]{3}=)?$)", "https?://(?:www\\.)?noriskdomain\\.com/[a-f0-9]{32}/analyze\\?u=([a-zA-Z0-9_/\\+\\=\\-%]+)", "https?://(?:\\w+\\.)?djurl\\.com/\\?r=([a-zA-Z0-9_/\\+\\=\\-%]+)", "https?://(?:\\w+\\.)?hbrowse\\.com/redirect/([a-zA-Z0-9_/\\+\\=\\-%]+)", "https?://(?:www\\.)?bookgn\\.com/engine/go\\.php\\?url=([a-zA-Z0-9_/\\+\\=\\-%]+)", "http://(?:www\\.)?vip-files\\.net/download\\.php\\?e=([a-zA-Z0-9_/\\+\\=\\-%]+)", "https?://(?:www\\.)?psdkeys\\.com/engine/go\\.php\\?url=([a-zA-Z0-9_/\\+\\=\\-%]+)", "https?://(?:www\\.)?hovatek\\.com/redirectcode\\.php\\?link=([a-zA-Z0-9_/\\+\\=\\-%]+)",
