...
public class FexNetCrawler extends PluginForDecrypt {
    public FexNetCrawler(PluginWrapper wrapper) {
        super(wrapper);
    }
    ...
    public ArrayList<DownloadLink> decryptIt(final CryptedLink param, ProgressController progress) throws Exception {
        ...
        do {
            ...
            if (childrenO != null) {
                final List<Map<String, Object>> ressourcelist = (List<Map<String, Object>>) childrenO;
                for (final Map<String, Object> file : ressourcelist) {
                    final long id = ((Number) file.get("id")).longValue();
                    final String name = (String) file.get("name");
                    if (StringUtils.isEmpty(name)) {
                        throw new PluginException(LinkStatus.ERROR_PLUGIN_DEFECT);
                    }
                    if (Boolean.TRUE.equals(file.get("is_dir"))) {
                        ...
                        /* Single file */
                        final String download_url = (String) file.get("download_url");
