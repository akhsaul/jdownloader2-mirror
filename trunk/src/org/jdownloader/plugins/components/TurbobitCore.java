...
public abstract class TurbobitCore extends PluginForHost {
    ...
    private Map<String, Object> checkErrorsWebsiteV2(final Browser br, final DownloadLink link, final Account account) throws PluginException {
        ...
        try {
            ...
            if (obj instanceof Map) {
                entries.putAll((Map<String, Object>) obj);
    ...
    protected void setConfigElements() {
        getConfig().addEntry(new ConfigEntry(ConfigContainer.TYPE_CHECKBOX, getPluginConfig(), SETTING_FREE_PARALLEL_DOWNLOADSTARTS, "Enable parallel download starts in free mode? <html><p style=\"color:#F62817\"><b>Warning: This setting may cause a large number of unaccepted CAPTCHA pop-ups!</b></p></html>").setDefaultValue(false));
