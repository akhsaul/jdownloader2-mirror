...
public class SendLogDialog extends AbstractDialog<Object> {
    ...
    public SendLogDialog(final List<LogFolder> folders) {
        super(0, _LogsTranslation.T.SendLogDialog_SendLogDialog_title_(), null, _LogsTranslation.T.LogAction_actionPerformed_upload_(), null);
    ...
    public JComponent layoutDialogContent() {
        ...
        if (folders == null || folders.size() == 0) {
            final JLabel noLogs = new JLabel(_LogsTranslation.T.SendLogDialog_layoutDialogContent_nologs_());
            noLogs.setForeground(Color.RED);
            noLogs.setHorizontalAlignment(SwingConstants.CENTER);
            panel.add(noLogs);
        } else {
            final JLabel lbl = new JLabel(_LogsTranslation.T.SendLogDialog_layoutDialogContent_desc_());
            panel.add(lbl);
